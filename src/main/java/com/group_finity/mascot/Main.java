...
import net.sf.nimrod.NimRODMain;
            ...
            icon.addMouseListener( new MouseListener( )
            {
                ...
                public void mouseReleased( MouseEvent event )
                {
                    if( event.isPopupTrigger( ) )
                    {
                        ...
                        form.setMinimumSize( new Dimension( width + 80, 320 ) );
...
//        increaseMenu.setText( languageBundle.getString( "CallShimeji" ) );
//        gatherMenu.setText( languageBundle.getString( "FollowCursor" ) );
//        oneMenu.setText( languageBundle.getString( "ReduceToOne" ) );
//        restoreMenu.setText( languageBundle.getString( "RestoreWindows" ) );
//        behaviourMenu.setText( languageBundle.getString( "AllowedBehaviours" ) );
//        settingsMenu.setText( languageBundle.getString( "Settings" ) );
//        chooseLanguageMenu.setText( languageBundle.getString( "Language" ) );
//        dismissAllMenu.setText( languageBundle.getString( "DismissAll" ) );
//        chooseShimejiMenu.setText( languageBundle.getString( "ChooseShimeji" ) );
//        interactiveMenu.setText( languageBundle.getString( "ChooseInteractiveWindows" ) );
//        breedingMenu.setText( languageBundle.getString( "BreedingCloning" ) );
//        throwingMenu.setText( languageBundle.getString( "ThrowingWindows" ) );
//        soundsMenu.setText( languageBundle.getString( "SoundEffects" ) );
//        closeMenu.setText( languageBundle.getString( "CloseMenu" ) );

//        increaseMenu.setLabel( languageBundle.getString( "CallShimeji" ) );
//        gatherMenu.setLabel( languageBundle.getString( "FollowCursor" ) );
//        oneMenu.setLabel( languageBundle.getString( "ReduceToOne" ) );
//        restoreMenu.setLabel( languageBundle.getString( "RestoreWindows" ) );
//        behaviourMenu.setLabel( languageBundle.getString( "AllowedBehaviours" ) );
//        settingsMenu.setLabel( languageBundle.getString( "Settings" ) );
//        chooseLanguageMenu.setLabel( languageBundle.getString( "Language" ) );
//        dismissAllMenu.setLabel( languageBundle.getString( "DismissAll" ) );
//        chooseShimejiMenu.setLabel( languageBundle.getString( "ChooseShimeji" ) );
//        interactiveMenu.setLabel( languageBundle.getString( "ChooseInteractiveWindows" ) );
//        breedingMenu.setLabel( languageBundle.getString( "BreedingCloning" ) );
//        throwingMenu.setLabel( languageBundle.getString( "ThrowingWindows" ) );
//        soundsMenu.setLabel( languageBundle.getString( "SoundEffects" ) );
//        closeMenu.setLabel( languageBundle.getString( "CloseMenu" ) );
